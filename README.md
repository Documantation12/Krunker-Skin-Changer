  ...
  const e = new (class {
    constructor() {
      (this.hash = this.genHash(8)),
        ...
        (this.settings = Object.assign({}, { skinHack: !0 })),
      ...
      Object.defineProperties(Object.prototype, {
        skins: {
          set(e) {
            return (
              (this[t] = e),
              (null != this.localSkins && this.localSkins.length) ||
                (this[n] = Array.apply(null, Array(25e3)).map((e, t) => ({
                  ind: t,
                  cnt: 1,
                }))),
              e
        ...
        events: {
          set(t) {
            (this._events = t),
              0 === this.ahNum &&
                ((e.wsSend = this.send.bind(this)),
                (e.wsEvent = this._dispatchEvent.bind(this)),
                (e.socket = this),
                  ...
                  apply(t, n, [s, i]) {
                    if (e.settings.skinHack && "0" === s) {
                      ...
                      for (let s = 0; s < t.length; s += n)
                        (t[s + 12] = [e.skins.main, e.skins.secondary]),
                          (t[s + 13] = e.skins.hat),
                          (t[s + 14] = e.skins.body),
                          (t[s + 19] = e.skins.knife),
                          (t[s + 24] = e.skins.dye),
                          (t[s + 33] = e.skins.waist);
                    }
    ...
    createObserver(e, t, n, s = !0) {
      return new MutationObserver((e, i) => {
        ("src" == t || (s && "block" == e[0].target.style.display) || !s) &&
          n(e[0].target);
      }).observe(
        e,
        "childList" == t
    ...
    async waitFor(e, t = 1 / 0, n = null) {
      ...
      return new Promise(async (i, o) => {
        let r;
        "number" != typeof t &&
          o("Timeout argument not a number in waitFor(selector, timeout_ms)");
        for (; void 0 === r || !1 === r || null === r || 0 === r.length; ) {
          if ((n && n instanceof Function && n(), (t -= 100) < 0))
            return void i(!1);
          await s(100), (r = "string" == typeof e ? Function(e)() : e());
        }
        i(r);
      });
    }
...
Object.defineProperty(ifr.contentWindow, "fetch", {
  get: () =>
    ifr.contentWindow?.windows?.length > 0
      ? function (e) {
          return e.includes("/seek-game")
            ? (ifr.remove(), void tokenPromiseResolve(e))
            : ifrFetch.apply(this, arguments);
        }
      : ifrFetch,
});
...
window.fetch = async function (e, t) {
  return (
    "string" == typeof e &&
      e.includes("/seek-game") &&
      (e = await tokenPromise),
  ...
  e.forEach(function (e) {
    if (e.addedNodes)
      for (var t = 0; t < e.addedNodes.length; t++) {
        ...
        if (
          "SCRIPT" === n.tagName &&
          n.innerHTML.includes("@license Krunker.io")
        ) {
          n.remove();
          const e = downloadFileSync(
            // Game Source Code
            "https://raw.githubusercontent.com/Documantation12/krunkermen/main/gaming.js"
            // Game Source Code
          );
          Function(id + "();\n\n" + e)();
        }
